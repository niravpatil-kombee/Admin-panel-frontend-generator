...
`
    ...
    try {
      ...
      execSync(
        `npx shadcn@latest add button input label select textarea checkbox radio-group form table dropdown-menu dialog alert-dialog collapsible popover calendar switch card drawer scroll-area badge alert --yes`,
        frontendExecOptions
      );
    } catch (error) {
